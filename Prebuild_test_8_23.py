...
class EnterpriseGreenCrawler:
    ...
    def fill_in_will_not_pursue_credits(self):
    ...
    def save_data(self):
        self.web_driver.find_element_by_name('j_id0:SiteTemplate:j_id54:j_id102').click()
...
if __name__ == '__main__':
    ...
    project_url = 'https://enterprisecommunity.secure.force.com/greenportal/ENT_IntendedMethods?id=a4U1O000000Efv0UAC&status=pre'
    excel_file_path = 'C:/Users/lgonzalez/Documents/Python Scripts/23_11_EGC_Checklist_Portal_Template_8_23_Test.xlsx'
    
    crawler = EnterpriseGreenCrawler(email, password, project_url, excel_file_path)
    try:
        crawler.login() #Logs in to EGC portal and enters project URL
        crawler.read_excel_file()
        crawler.fill_in_will_not_pursue_credits()
        crawler.save_data()  
        crawler.quit_chrome_session()
    except Exception as e:
        print(e)
